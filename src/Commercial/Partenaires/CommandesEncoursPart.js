...
const client = clientsData && clientsData.length > 0 ? clientsData[0] : null;  const [users, setUsers] = useState([]);
...
`;
  ...
  const handleSaveCommunication = async () => {
   ...
   if (modeLivraison?.LIBELLE === "transporteur") {
          ...
          >
            ...
            >
              ...
              <CustomCardActions>
                ...
                disabled={["Annulée", "Annul@e", "Traité", "Trait@", "Livré"].includes(etat)}>
                  Appeler
                </Button>
